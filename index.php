...
?>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12 col-lg-6">
                    <h1 class="display-3 text-dark mb-4 animated slideInDown"> Get Loan for your Business growth or startup </h1>
    ...
    <div class="container-xxl py-5">
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 500px">
          <h1 class="display-6 mb-5"> What we offer for you </h1>
        ...
        <div class="row g-4 justify-content-center">
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item rounded h-100 p-5">
              ...
              <a class="btn btn-light px-3" href="contectus.php">Apply Now</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                <h4 class="mb-0">Commerical Vehicle Loan</h4>
              </div>
              <p class="mb-4"> Aliqu diam amet eos erat ipsum et lorem et sit, sed stet lorem sit clita duo justo erat amet </p>
              <a class="btn btn-light px-3" href="contectus.php">Apply Now</a>
            </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                <h4 class="mb-0">Loan Against Propert</h4>
              </div>
              <p class="mb-4"> Aliqu diam amet eos erat ipsum et lorem et sit, sed stet lorem sit clita duo justo erat amet </p>
              <a class="btn btn-light px-3" href="contectus.php">Apply Now</a>
            </div>
    ...
    < <div class="works_area" id="how-it-work">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="container-xxl py-5">
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 500px">
          <h1 class="display-6 mb-5">What They Say About Our Loan</h1>
        </div>
        <div class="row g-5">
